      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">
            Step 1 of 3 – Choose location and School type
          </h2>
        </div>
        ...
        <div>
          ...
          {errors.state && (
            <p className="text-red-600 text-sm mt-1 font-medium">{errors.state.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          {errors.schoolType && (
            <p className="text-red-600 text-sm mt-1 font-medium">{errors.schoolType.message}</p>
          )}
        </div>
