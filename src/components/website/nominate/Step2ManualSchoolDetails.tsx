...
export default function Step2ManualSchoolDetails({
    ...
    return (
        <div
            ...
            style={{
                backgroundImage: "url('/images/websites/nominate/step-2.png')",
            }}
        >
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <button
                                ...
                                className={`py-4 px-6 rounded-lg text-base font-semibold transition-all ${values.schoolType === 'Primary'
                            ...
                            <button
                                ...
                                className={`py-4 px-6 rounded-lg text-base font-semibold transition-all ${values.schoolType === 'Secondary'
                                    ? 'bg-white text-gray-900 shadow-lg'
                                    : 'bg-white/50 text-gray-700 hover:bg-white/80'
                                    }`}
                            >
